...
extension ViewController {
    ...
    private func setFirstContainer() {
        ...
        let firstViewHeight = containerView.frame.size.height
        let firstViewWidth = containerView.frame.size.width
    ...
    private func setSecondContainer() {
        ...
        let secondViewHeight = containerView.frame.size.height
        let secondViewWidth = containerView.frame.size.width
